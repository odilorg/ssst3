                    ...
                    ->tabs([
                        ...
                        Tabs\Tab::make('🎯 Content')
                            ->schema([
                                ...
                                Section::make('Tour Highlights & Inclusions')
                                    ->schema([
                        ...
                        // TAB 4: ITINERARY
                        // ========================================
                        Tabs\Tab::make('🗓️ Itinerary')
                            ->schema([
                                Section::make('Tour Schedule')
                                    ->description('День за днем план тура')
                                    ->schema([
                                        Repeater::make('itineraryItems')
                                            ...
                                            ->itemLabel(fn (array $state): ?string =>
                                                ($state['day_number'] ?? '')
                                                    ? "Day {$state['day_number']}: " . ($state['title'] ?? 'Новый пункт')
                                                    : ($state['title'] ?? 'Новый пункт')
                                            )
