                ...
                Section::make('Цены')
                    ...
                    ->schema([
                        ...
                        Repeater::make('transportInstancePrices')
                            ...
                            ->defaultItems(0)
                            ->helperText('Удалите ВСЕ цены (с помощью иконки 🗑️), чтобы использовать стандартные цены типа транспорта. Если цена остается в списке, все поля должны быть заполнены.')
                            ->columnSpanFull(),
                    ])
                    ->columns(1)
                    ->collapsible()
