    ...
    <section class="tours-hero">
        ...
        <div class="container">
            <div class="tours-hero__content">
                <h1 class="tours-hero__title">🌟 Mini Journeys</h1>
                <p class="tours-hero__subtitle">Quick adventures and overnight camping experiences across Uzbekistan. Perfect for travelers with limited time who want authentic cultural immersion in 1-2 days.</p>
                <a href="#mini-journeys" class="hero-cta-btn">
                    Explore Mini Journeys
    ...
    <nav class="breadcrumb" aria-label="Breadcrumb" style="background: #f8f9fa; padding: 1rem 0;">
        <div class="container">
            <ol style="list-style: none; padding: 0; margin: 0; display: flex; align-items: center; flex-wrap: wrap;">
                ...
                <li style="color: #666; font-weight: 500;" aria-current="page">Mini Journeys</li>
            </ol>
        </div>
    </nav>
