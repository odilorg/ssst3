...
@section('title', 'Craft Journeys - Multi-Day Boutique Tours | Uzbekistan Silk Road')
    ...
    <section class="tours-hero">
        ...
        <div class="container">
            <div class="tours-hero__content">
                <h1 class="tours-hero__title">🎨 Craft Journeys</h1>
                <p class="tours-hero__subtitle">Immersive multi-day adventures with carefully curated boutique hotels, artisan workshops, and deep cultural experiences across Uzbekistan's Silk Road.</p>
    ...
    <nav class="breadcrumb" aria-label="Breadcrumb" style="background: #f8f9fa; padding: 1rem 0;">
        <div class="container">
            <ol style="list-style: none; padding: 0; margin: 0; display: flex; align-items: center; flex-wrap: wrap;">
                ...
                <li style="color: #666; font-weight: 500;" aria-current="page">Craft Journeys</li>
            </ol>
        </div>
    </nav>
    ...
    <section id="craft-journeys" style="padding: 80px 0; background: #f9fafb;">
        <div class="container">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 2rem; margin-bottom: 2rem;">
                @foreach($initialTours as $craftTour)
