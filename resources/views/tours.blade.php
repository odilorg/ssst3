...
<!-- City Filter -->                        <div class="filter-group">                            <label for="city" class="filter-group__label">                                <i class="fas fa-map-marker-alt" aria-hidden="true"></i>                                City                            </label>                            <select id="city" name="city" class="filter-select">                                <option value="">All Cities</option>                                <option value="3">Bukhara</option>                                <option value="4">Khiva</option>                                <option value="2">Samarkand</option>                                <option value="1">Tashkent</option>                            </select>                        </div>
        ...
        <div class="container">
            <div class="footer-main">
                ...
                <div class="footer-brand">
                    ...
                    <p>📧 info@jahongir-travel.uz</p>
                    <p>📞 +998 91 555 08 08</p>
                </div>
                ...
                <div class="footer-col">
                    ...
                    <ul class="footer-nav__list">
                        <li><a href="/tours/5-day-silk-road-classic">Silk Road Classic</a></li>
                        <li><a href="/tours/samarkand-city-tour-registan-square-and-historical-monuments">Samarkand City Tour</a></li>
                        <li><a href="/tours/full-day-bukhara-city-tour">Bukhara City Tour</a></li>
                        <li><a href="/tours/konigil-day-tour">Konigil Day Tour</a></li>
                    </ul>
                </div>
